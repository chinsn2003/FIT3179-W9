...
This data package contains the data that powers the chart ["Annual deforestation"](https://ourworldindata.org/grapher/annual-deforestation?stackMode=absolute%C2%AEion&time=2010&mapSelect=~USA&overlay=download-data&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website. It was downloaded on September 29, 2025.

### Active Filters

A filtered subset of the full data was downloaded. The following filters were applied:
overlay: download-data
stackMode: absolute®ion
time: 2010
mapSelect: ~USA
